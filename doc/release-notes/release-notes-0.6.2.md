Cryptotarget version 0.6.2 is now available for download at:
http://sourceforge.net/projects/cryptotarget/files/Cryptotarget/cryptotarget-0.6.2/
...
Fixed https://github.com/cryptotarget/cryptotarget/issues/1065, a bug that
