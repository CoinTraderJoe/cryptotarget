Cryptotarget version 0.5.4 is now available for download at:
http://sourceforge.net/projects/cryptotarget/files/Cryptotarget/cryptotarget-0.5.4/
...
http://gitorious.org/cryptotarget/cryptotargetd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Cryptotarget-Qt notifications under Growl 1.3.
Increase required age of Cryptotarget-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxCryptotarget properly when installing Cryptotarget-Qt over it. (Windows)
