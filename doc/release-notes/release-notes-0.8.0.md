Cryptotarget-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/cryptotarget/files/Cryptotarget/cryptotarget-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Cryptotarget
...
New/changed settings (command-line or cryptotarget.conf file)
--------------------------------------------------------
