The following is a list of assets used in the cryptotarget source and their proper attribution.
...
* License: MIT
* Site: [https://cryptotargettalk.org/index.php?topic=15276.0](https://cryptotargettalk.org/index.php?topic=15276.0)
...
### Info
* Designer: Jonas Schnelli (based on the original cryptotarget logo from Bitboy)
* License: MIT

### Assets Used
	src/qt/res/icons/cryptotarget.icns, src/qt/res/src/cryptotarget.svg,
	src/qt/res/src/cryptotarget.ico, src/qt/res/src/cryptotarget.png,
	src/qt/res/src/cryptotarget_testnet.png, docs/cryptotarget_logo_doxygen.png,
