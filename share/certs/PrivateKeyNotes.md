...
unlocked to sign the Cryptotarget-Qt.app bundle.
...
allowing somebody to distribute a Cryptotarget-Qt.app or cryptotarget-qt-setup.exe with a valid
...
that the cryptotarget-qt.exe file inside the installer had not been tampered with.
