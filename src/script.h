...
#ifndef H_CRYPTOTARGET_SCRIPT
#define H_CRYPTOTARGET_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CCryptotargetAddress
 */
...
public:
    ...
    // Pre-version-0.6, Cryptotarget always counted CHECKMULTISIGs
