...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false))
    {
        ...
        intro.setWindowIcon(QIcon(":icons/cryptotarget"));
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Cryptotarget"),
     ...
     * override -datadir in the cryptotarget.conf file in the default data directory
     * (to be consistent with cryptotargetd behavior)
     */
    if(dataDir != getDefaultDataDirectory())
