...
#if defined(NDEBUG)
# error "Cryptotarget cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Cryptotarget Signed Message:\n";
...
{
    int64_t nSubsidy = 4000000000 + nHeight * COIN; 
	
	 if (nHeight == 1)
    {
        nSubsidy = 299999999999999  + nHeight * COIN;  // Premine
    }
    else if (nHeight > 1)
    {
        nSubsidy = 4000000000 + nHeight  * COIN; 
...
void ThreadScriptCheck() {
    RenameThread("cryptotarget-scriptch");
