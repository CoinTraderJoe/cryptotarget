AC_DEFUN([CRYPTOTARGET_FIND_BDB48],[
  ...
  if test "x$bdbpath" = "xX"; then
    ...
    CRYPTOTARGET_SUBDIR_TO_INCLUDE(BDB_CPPFLAGS,[${bdbpath}],db_cxx)
    ...
    CRYPTOTARGET_SUBDIR_TO_INCLUDE(BDB_CPPFLAGS,[${bdb48path}],db_cxx)
    bdbpath="${bdb48path}"
  fi
